...
class ProductsContainercopy extends Component {
    componentDidMount() {
...
ProductsContainercopy.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductsContainercopy);
